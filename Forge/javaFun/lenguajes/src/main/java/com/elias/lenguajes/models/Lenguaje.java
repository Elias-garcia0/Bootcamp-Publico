package com.elias.lenguajes.models;
...
public class Lenguaje {
	...
	public Lenguaje(String name, String creator, String numberOfVersion) {
		this.name = name;
		this.creator = creator;
		this.numberOfVersion = numberOfVersion;
	}
	public Lenguaje(Long id,String name, String creator, String numberOfVersion) {
		this.name = name;
		this.creator = creator;
		this.numberOfVersion = numberOfVersion;
	}
